...
| 17 | 02 - Fraud Agent - 10 - Fraud Geo Agent | 3–10 min | Space **Fraud Geo Agent** | Default system prompt is detect + required-data notes (no next steps). Optional Action input **system_prompt** overrides it. |
